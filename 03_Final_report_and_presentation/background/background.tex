...
During the training process, as the training continues the reward is shifted toward weighting $R_2$ higher.
...
Within drone perching this would likely relate to the location of the branch-like structure.
Additionally, the tether itself could be treated as an obstacle that needs to be avioded.
